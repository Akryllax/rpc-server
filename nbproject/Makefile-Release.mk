...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rpc-arma3

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rpc-arma3: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rpc-arma3 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/NetworkEntity.o: NetworkEntity.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NetworkEntity.o NetworkEntity.cpp

${OBJECTDIR}/PacketInterpreter.o: PacketInterpreter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PacketInterpreter.o PacketInterpreter.cpp

${OBJECTDIR}/lib/lua-5.3.3/src/lapi.o: lib/lua-5.3.3/src/lapi.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lapi.o lib/lua-5.3.3/src/lapi.c

${OBJECTDIR}/lib/lua-5.3.3/src/lauxlib.o: lib/lua-5.3.3/src/lauxlib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lauxlib.o lib/lua-5.3.3/src/lauxlib.c

${OBJECTDIR}/lib/lua-5.3.3/src/lbaselib.o: lib/lua-5.3.3/src/lbaselib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lbaselib.o lib/lua-5.3.3/src/lbaselib.c

${OBJECTDIR}/lib/lua-5.3.3/src/lbitlib.o: lib/lua-5.3.3/src/lbitlib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lbitlib.o lib/lua-5.3.3/src/lbitlib.c

${OBJECTDIR}/lib/lua-5.3.3/src/lcode.o: lib/lua-5.3.3/src/lcode.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lcode.o lib/lua-5.3.3/src/lcode.c

${OBJECTDIR}/lib/lua-5.3.3/src/lcorolib.o: lib/lua-5.3.3/src/lcorolib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lcorolib.o lib/lua-5.3.3/src/lcorolib.c

${OBJECTDIR}/lib/lua-5.3.3/src/lctype.o: lib/lua-5.3.3/src/lctype.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lctype.o lib/lua-5.3.3/src/lctype.c

${OBJECTDIR}/lib/lua-5.3.3/src/ldblib.o: lib/lua-5.3.3/src/ldblib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/ldblib.o lib/lua-5.3.3/src/ldblib.c

${OBJECTDIR}/lib/lua-5.3.3/src/ldebug.o: lib/lua-5.3.3/src/ldebug.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/ldebug.o lib/lua-5.3.3/src/ldebug.c

${OBJECTDIR}/lib/lua-5.3.3/src/ldo.o: lib/lua-5.3.3/src/ldo.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/ldo.o lib/lua-5.3.3/src/ldo.c

${OBJECTDIR}/lib/lua-5.3.3/src/ldump.o: lib/lua-5.3.3/src/ldump.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/ldump.o lib/lua-5.3.3/src/ldump.c

${OBJECTDIR}/lib/lua-5.3.3/src/lfunc.o: lib/lua-5.3.3/src/lfunc.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lfunc.o lib/lua-5.3.3/src/lfunc.c

${OBJECTDIR}/lib/lua-5.3.3/src/lgc.o: lib/lua-5.3.3/src/lgc.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lgc.o lib/lua-5.3.3/src/lgc.c

${OBJECTDIR}/lib/lua-5.3.3/src/linit.o: lib/lua-5.3.3/src/linit.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/linit.o lib/lua-5.3.3/src/linit.c

${OBJECTDIR}/lib/lua-5.3.3/src/liolib.o: lib/lua-5.3.3/src/liolib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/liolib.o lib/lua-5.3.3/src/liolib.c

${OBJECTDIR}/lib/lua-5.3.3/src/llex.o: lib/lua-5.3.3/src/llex.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/llex.o lib/lua-5.3.3/src/llex.c

${OBJECTDIR}/lib/lua-5.3.3/src/lmathlib.o: lib/lua-5.3.3/src/lmathlib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lmathlib.o lib/lua-5.3.3/src/lmathlib.c

${OBJECTDIR}/lib/lua-5.3.3/src/lmem.o: lib/lua-5.3.3/src/lmem.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lmem.o lib/lua-5.3.3/src/lmem.c

${OBJECTDIR}/lib/lua-5.3.3/src/loadlib.o: lib/lua-5.3.3/src/loadlib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/loadlib.o lib/lua-5.3.3/src/loadlib.c

${OBJECTDIR}/lib/lua-5.3.3/src/lobject.o: lib/lua-5.3.3/src/lobject.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lobject.o lib/lua-5.3.3/src/lobject.c

${OBJECTDIR}/lib/lua-5.3.3/src/lopcodes.o: lib/lua-5.3.3/src/lopcodes.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lopcodes.o lib/lua-5.3.3/src/lopcodes.c

${OBJECTDIR}/lib/lua-5.3.3/src/loslib.o: lib/lua-5.3.3/src/loslib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/loslib.o lib/lua-5.3.3/src/loslib.c

${OBJECTDIR}/lib/lua-5.3.3/src/lparser.o: lib/lua-5.3.3/src/lparser.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lparser.o lib/lua-5.3.3/src/lparser.c

${OBJECTDIR}/lib/lua-5.3.3/src/lstate.o: lib/lua-5.3.3/src/lstate.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lstate.o lib/lua-5.3.3/src/lstate.c

${OBJECTDIR}/lib/lua-5.3.3/src/lstring.o: lib/lua-5.3.3/src/lstring.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lstring.o lib/lua-5.3.3/src/lstring.c

${OBJECTDIR}/lib/lua-5.3.3/src/lstrlib.o: lib/lua-5.3.3/src/lstrlib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lstrlib.o lib/lua-5.3.3/src/lstrlib.c

${OBJECTDIR}/lib/lua-5.3.3/src/ltable.o: lib/lua-5.3.3/src/ltable.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/ltable.o lib/lua-5.3.3/src/ltable.c

${OBJECTDIR}/lib/lua-5.3.3/src/ltablib.o: lib/lua-5.3.3/src/ltablib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/ltablib.o lib/lua-5.3.3/src/ltablib.c

${OBJECTDIR}/lib/lua-5.3.3/src/ltm.o: lib/lua-5.3.3/src/ltm.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/ltm.o lib/lua-5.3.3/src/ltm.c

${OBJECTDIR}/lib/lua-5.3.3/src/lua.o: lib/lua-5.3.3/src/lua.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lua.o lib/lua-5.3.3/src/lua.c

${OBJECTDIR}/lib/lua-5.3.3/src/luac.o: lib/lua-5.3.3/src/luac.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/luac.o lib/lua-5.3.3/src/luac.c

${OBJECTDIR}/lib/lua-5.3.3/src/lundump.o: lib/lua-5.3.3/src/lundump.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lundump.o lib/lua-5.3.3/src/lundump.c

${OBJECTDIR}/lib/lua-5.3.3/src/lutf8lib.o: lib/lua-5.3.3/src/lutf8lib.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lutf8lib.o lib/lua-5.3.3/src/lutf8lib.c

${OBJECTDIR}/lib/lua-5.3.3/src/lvm.o: lib/lua-5.3.3/src/lvm.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lvm.o lib/lua-5.3.3/src/lvm.c

${OBJECTDIR}/lib/lua-5.3.3/src/lzio.o: lib/lua-5.3.3/src/lzio.c 
	${MKDIR} -p ${OBJECTDIR}/lib/lua-5.3.3/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/lua-5.3.3/src/lzio.o lib/lua-5.3.3/src/lzio.c
...
${OBJECTDIR}/request_processor.o: request_processor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/request_processor.o request_processor.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rpc-arma3
